      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          <Link href={`/artists/${artist.id}`} className="block">
            <h3 className="text-sm text-stone-800 hover:underline dark:text-stone-200">
              {artist.user
        ...
        {artist.shops && artist.shops.length > 0 && (
          <div className="flex items-center gap-1 border-t border-stone-200 pt-2 text-[10px] uppercase tracking-wider text-stone-400 dark:border-stone-700 dark:text-stone-500">
